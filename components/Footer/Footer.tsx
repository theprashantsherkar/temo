...
export default function Footer() {
    return (
        <footer className="flex flex-col  border  border-white  items-center justify-between  bg-gray-800 text-white text-center">
            <div className='flex sm:flex-row flex-col items-start justify-between gap-4 p-7 bg-gray-800 text-white text-center'>
