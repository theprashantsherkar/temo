    ...
    return (
        <>
            ...
            <div className='min-h-fit  sm:h-[130vh] gap-8 bg-black text-white flex flex-col items-center  justify-center'>
                ...
                <div className='w-full px-5 sm:w-2/3 flex flex-col items-center justify-center text-center' >
                ...
                <div className='px-5 w-full sm:w-2/3 flex flex-col items-center justify-center text-center'>
